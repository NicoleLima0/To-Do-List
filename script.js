...
const saveTodo = (text, done = 0, save = 1) => {
  ...
  //criando o template pelo js
  const todoTitle = document.createElement("h3");
  todoTitle.innerText = text;//texto que recebo da função que vem do valor do input
...
// Eventos
todoForm.addEventListener("submit", (e) => {//Para enviar o formulário
e.preventDefault();//Para que o formulário não seja enviado para o back-end.

  const inputValue = todoInput.value;//Peguei o valor do input que o usuário digita e criei uma tarefa nova

  if (inputValue) { //validação para que o usuário não crie tarefa sem título
    saveTodo(inputValue);// salvando o ToDo
  }
});
